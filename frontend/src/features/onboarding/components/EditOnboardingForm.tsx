...
export const EditOnboardingForm: React.FC<EditOnboardingFormProps> = ({
    onboarding,
    onUpdated,
    onCancel,
    onboardings,
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            const nameExists = onboardings.some(
                (o) =>
                    o.onboardingId !== onboarding.onboardingId &&
            ...
            try {
                await updateOnboarding(onboarding.onboardingId, {
                    name: values.name,
                ...
                setModalTitle("Éxito");
                setModalMessage("Onboarding actualizado correctamente.");
                setModalIcon(
                ...
                setModalTitle("Error");
                setModalMessage("Error al actualizar onboarding.");
                setModalIcon(
                    <FaTimesCircle className="w-12 h-12 text-red-600" />
                );
                setIsModalOpen(true);
